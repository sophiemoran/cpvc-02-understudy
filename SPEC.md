...
- **Experience:** [What appears first, next and last; one restrained accent; a concrete reference or layout rule]. Readable on a laptop; mobile is not required for this session.
